...
import com.ipulcrimx.sparkcalculator.Listeners.CountListener;
import com.ipulcrimx.sparkcalculator.fragments.DailyLoginFragment;
import com.ipulcrimx.sparkcalculator.fragments.MainLayoutFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _manager.beginTransaction()
                .replace(R.id.main_layout , new MainLayoutFragment())
                .commit();
...
//        _countButton.setOnClickListener(new CountListener(this));
//        CreatePopUp();
    }
    ...
    @Override
    // ini menu yang ada di ujung kanan atas
...
//            Toast.makeText(this, "This is Menu", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.daily_login) {
            _manager.beginTransaction()
                    .replace(R.id.main_layout , new DailyLoginFragment())
                    .commit();

        } else if (id == R.id.side_stories) {
    ...
    public void SetResultText(int xtal, int tot, int tix)
    {
